...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIView *moreSkillView = [ODClassMethod creatViewWithFrame:CGRectMake(0, 6, kScreenSize.width, 28) tag:0 color:@"#ffffff"];
        ...
        self.moreSkillButton = [ODClassMethod creatButtonWithFrame:CGRectMake((kScreenSize.width - 160) / 2, 5, 160, 20) target:self sel:nil tag:0 image:nil title:@"想了解更多技能？ 憋说话，点我！" font:9];
