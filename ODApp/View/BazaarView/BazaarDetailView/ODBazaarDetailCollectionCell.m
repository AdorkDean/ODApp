...
- (void)awakeFromNib {
    ...
    self.nickLabel.textColor = [ODColorConversion colorWithHexString:@"#484848" alpha:1];
    self.signLabel.textColor = [ODColorConversion colorWithHexString:@"#d0d0d0" alpha:1];
}
