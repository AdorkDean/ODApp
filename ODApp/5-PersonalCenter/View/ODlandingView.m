...
+(instancetype)getView
{
   ODlandingView *view = [[[NSBundle mainBundle] loadNibNamed:@"ODlandingView" owner:nil options:nil] firstObject];
    ...
    view.accountLabel.layer.borderColor = [UIColor colorWithRGBString:@"#dcdcdc" alpha:1].CGColor;
    ...
    view.passwordLabel.layer.borderColor = [UIColor colorWithRGBString:@"#dcdcdc" alpha:1].CGColor;
    view.passwordLabel.layer.borderWidth = 0.5f;
    
    view.landButton.layer.masksToBounds = YES;
    view.landButton.layer.cornerRadius = 5;
    view.landButton.layer.borderColor = [UIColor colorWithRGBString:@"#333333" alpha:1].CGColor;
    view.landButton.layer.borderWidth = 0.5f;
    view.landButton.backgroundColor = [UIColor colorWithRGBString:@"#ffd801" alpha:1];
