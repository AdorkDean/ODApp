...
- (void)makeLaunchView
{
    ...
    self.pageControl = [[MyPageControl alloc] initWithFrame:CGRectMake( self.ViewController.view.center.x - 50,  self.ViewController.view.center.y + self.length - 10, 200, 30) normalImage:[UIImage imageNamed:@"selected.png"] highlightedImage:[UIImage imageNamed:@"noselected.png"] dotsNumber:4 sideLength:15 dotsGap:10];
