...
{
    [self.headImageView sd_setImageWithURL:[NSURL OD_URLWithString:model.icon_url] placeholderImage:[UIImage imageNamed:@"placeholderImage"]options:SDWebImageRetryFailed];
