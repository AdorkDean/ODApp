    ...
    [self.manager GET:kGetMyOrderListUrl parameters:signParameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if (responseObject) {
            ...
            if ([responseObject[@"status"]isEqualToString:@"success"]) {
                ...
                {
                    weakSelf.noReusltLabel = [ODClassMethod creatLabelWithFrame:CGRectMake((kScreenSize.width - 160)/2, kScreenSize.height/2, 160, 30) text:@"暂无购买纪录" font:16 alignment:@"center" color:@"#000000" alpha:1];
