...
-(void)navigationInit
{
    ...
    self.allTaskButton = [ODClassMethod creatButtonWithFrame:CGRectMake(kScreenSize.width - 100, 28,90, 20) target:self sel:@selector(typeAction:) tag:0 image:nil title:@"全部任务V" font:17];
