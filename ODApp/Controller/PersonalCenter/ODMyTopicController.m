...
-(void)firstGetData
{
    ...
    NSDictionary *parameters = @{ @"type":@"1",@"page":countNumber , @"city_id":[ODUserInformation sharedODUserInformation].cityID ,@"open_id":self.open_id};
...
-(void)secondGetData
{
    ...
    NSDictionary *parameters = @{ @"type":@"2",@"page":countNumber, @"city_id":[ODUserInformation sharedODUserInformation].cityID , @"open_id":self.open_id  , @"call_array":@"1"};
    NSDictionary *signParameters = [ODAPIManager signParameters:parameters];
